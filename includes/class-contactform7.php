...
require_once ('functions-kontrol.php');
    ...
    { 
        ...
        public function tagEkleTcKimlik(){   
            ...
            wpcf7_add_form_tag(array('tckimlik','tckimlik*'),array($this,'tagOlustur'),
            array(
    			'name-attr' => true,
    		));
        }
        ...
        public function semayaEkle() {
            ...
            $tag_generator->add( 'tckimliknvi', __( 'tckimlik nvi', 'tcinput' ),
                array($this,'nviSemaOlustur'));  
            $tag_generator->add( 'tckimlik', __( 'tckimlik', 'tcinput' ),
